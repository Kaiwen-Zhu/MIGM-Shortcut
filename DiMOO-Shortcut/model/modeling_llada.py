    ...
    def forward(
        ...
        **kwargs
        ...
        if output_hidden_states:
            ...
            all_hidden_states.append(x)
        last_feat = x.clone() if kwargs.get("ret_last_feat", False) else None
        ...
        return LLaDAOutput(logits=logits, attn_key_values=attn_key_values, hidden_states=tuple(all_hidden_states) if output_hidden_states else None), last_feat  # type: ignore[arg-type]
...
class LLaDAModelLM(PreTrainedModel):
    ...
    def forward(
        ...
        **kwargs
        ...
        outputs, last_feat = self.model.forward(
            input_ids=input_ids,
